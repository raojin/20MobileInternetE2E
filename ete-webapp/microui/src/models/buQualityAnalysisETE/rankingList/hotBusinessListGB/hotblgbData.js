...
import { queryHotData } from 'services/buQualityAnalysisETE/rankingList/hotBusinessListGB/hotblgbServer';
const { prefix } = config

//从models/commmon/common/pageModel继承模型
export default modelExtend(pageModel, {
  //模型命名空间
  namespace: 'hotblgbData',
  ...
  subscriptions:{
    ...
    setup ({ dispatch, history }) {
      ...
      history.listen(location => {
        ...
        dispatch({
          type: `queryHotData`,
          payload: {level:'day',timeId:'20171210',areaId:'851',netType:'4G',field_type:'flow',app_type:'hot',logo_type:'small',top:'10'}
        });
      })
    },
  },
  ...
  effects: {
    *queryHotData ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryHotData, payload)
