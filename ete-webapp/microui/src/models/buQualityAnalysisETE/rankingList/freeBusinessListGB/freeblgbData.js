...
import { queryFreeblGbData } from 'services/buQualityAnalysisETE/rankingList/freeBusinessListGB/freeblgbServer';
const { prefix } = config

//从models/commmon/common/pageModel继承模型
export default modelExtend(pageModel, {
  //模型命名空间
  namespace: 'freeblGbData',
  ...
  effects: {
    *queryFreeblGbData ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryFreeblGbData, payload)
