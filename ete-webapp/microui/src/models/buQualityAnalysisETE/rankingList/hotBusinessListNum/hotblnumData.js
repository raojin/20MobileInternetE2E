...
import { queryHotnumData } from 'services/buQualityAnalysisETE/rankingList/hotBusinessListNum/hotblnumServer';
const { prefix } = config

//从models/commmon/common/pageModel继承模型
export default modelExtend(pageModel, {
  //模型命名空间
  namespace: 'hotblnumData',
  ...
  effects: {
    *queryHotnumData ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryHotnumData, payload)
