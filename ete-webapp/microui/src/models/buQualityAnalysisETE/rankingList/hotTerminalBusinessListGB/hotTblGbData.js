...
import { queryHotTblGbData } from 'services/buQualityAnalysisETE/rankingList/hotTerminalBusinessListGB/hottblgbServer';
const { prefix } = config

//从models/commmon/common/pageModel继承模型
export default modelExtend(pageModel, {
  //模型命名空间
  namespace: 'hottblgbData',
  ...
  effects: {
    *queryHotTblGbData ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryHotTblGbData, payload)
