...
import { queryBusiness} from 'services/buQualityAnalysisETE/buAnalysisComposition/twoBusinessAnalysis/twoBusinessAnalysisServer';
  ...
  subscriptions:{
    ...
    setup ({ dispatch, history }) {
      ...
      history.listen(location => {
        ...
        dispatch({
          type: `queryBusiness`,
          payload: {level:'day',timeId:'20171210',areaId:'851',netType:'4G',field_type:'flow',app_type_id:'15',app_type:'business'}
        });
      })
    },
  },
