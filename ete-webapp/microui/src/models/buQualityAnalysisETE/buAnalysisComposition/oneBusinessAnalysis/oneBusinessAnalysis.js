...
export default modelExtend(pageModel, {
  ...
  subscriptions:{
    ...
    setup ({ dispatch, history }) {
      ...
      history.listen(location => {
        ...
        dispatch({
          type: `queryBusinessType`,
          //level=day&timeId=20171218&areaId=851&netType=4G&cityId=
          payload: {level:'day',timeId:'20171210',areaId:'851',netType:'4G'}
        });
  ...
  effects: {
    *queryBusinessType ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryBusinessType, payload)
