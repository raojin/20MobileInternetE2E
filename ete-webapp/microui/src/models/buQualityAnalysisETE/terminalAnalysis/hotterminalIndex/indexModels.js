...
import { queryIndexData } from 'services/buQualityAnalysisETE/terminalAnalysis/hotterminalIndex/indexServer';
...
export default modelExtend(pageModel, {
  ...
  effects: {
    *queryIndexData ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryIndexData, payload)
