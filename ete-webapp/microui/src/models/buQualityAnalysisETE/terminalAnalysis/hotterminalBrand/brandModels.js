...
import { queryBrandData } from 'services/buQualityAnalysisETE/terminalAnalysis/hotterminalBrand/brandServer';
...
export default modelExtend(pageModel, {
  ...
  effects: {
    *queryBrandData ({ payload = {} }, { call, put }) {
      //异步调用totalErr方法
      const data = yield call(queryBrandData, payload)
