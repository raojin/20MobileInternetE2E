...
import './htblGbGrid.less'

class HtblGBGrid extends React.Component {
  _areaturnToMore = (e) =>  {
    console.log(this);
    alert("开发者正在努力开发中！");
  }
      ...
      <div className="p-e-div">
        <div className="p-e-div-1">
          <div className="di_left">
            <h5 className="fl"> <Icon type="caret-right"  style={{ fontSize: 14, color: '#08c'}}/>&nbsp;&nbsp;热门终端榜单(流量)
            </h5>
          </div>
