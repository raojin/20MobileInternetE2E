...
import './brandBerEcharts.less'
import { Icon } from 'antd'
import ReactDOM from 'react-dom'

class BrandBerEcharts extends React.Component {
      ...
      <div className="p-e-div">
        <div className="p-e-div-1">
          <div className="di_left">
            <h5 className="fl"> <Icon type="bars" style={{ fontSize: 22,color: '#0085d0'}}/>&nbsp;&nbsp;终端品牌TOP10
            </h5>
          </div>
...
export default BrandBerEcharts
